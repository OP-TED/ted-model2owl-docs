...
| `OLD_ONTOLOGY_DIR` | String | Root directory for old OWL/SHACL files. | `implementation`
| `NEW_ONTOLOGY_DIR` | String | Root directory for new OWL/SHACL files. | `implementation`
| `MODULES` | String | Comma-separated module names to diff (empty = auto-detect). | (empty)
