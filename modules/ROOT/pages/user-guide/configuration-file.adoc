...
|===
| Parameter Name | Data Type | Description | Default Value
| `changelogUrl` | String | URL to the changelog or release notes of the project | `https://github.com/OP-TED/ePO/releases`
...
| `feedbackUrl` | String | URL of the location where one can provide feedback about the specification | `https://github.com/organization/repo/issues`
...
| `owners.website` | String | Owner website (optional) | `https://www.tomsmith.com`
...
| `seeAlsoResources` | Array[String] | List of URLs providing additional resources or references related to the ontology | `['https://example1.com', 'https://example2.com']`
