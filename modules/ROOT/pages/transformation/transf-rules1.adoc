...
[NOTE]
If the class has attributes or related association or dependency connectors, all their term definitions are set within the single inner context object (see  link:transf-rules1.html#rule:assoc-dep-ldcontext[attribute], link:transf-rules1.html#rule:assoc-dep-type-ldcontext[attribute range], link:transf-rules1.html#rule:assoc-dep-container-ldcontext[attribute multiplicity], link:transf-rules2.html#rule:assoc-dep-ldcontext[association/dependency], link:transf-rules2.html#rule:assoc-dep-type-ldcontext[association/dependency range], link:transf-rules2.html#rule:assoc-dep-container-ldcontext[association/dependency multiplicity]). 
