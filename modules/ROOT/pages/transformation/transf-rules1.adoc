...
<rdf:Description rdf:about = "http://base.onto.uri/ClassName">
    <rdfs:subClassOf>
        <owl:Restriction>
            ...
            <owl:qualifiedCardinality rdf:datatype="http://www.w3.org...#integer" >2</owl:qualifiedCardinality>
        </owl:Restriction>
    </rdfs:subClassOf>
</rdf:Description>
----
...
<rdf:Description rdf:about = "http://base.onto.uri/ClassName">
    <rdfs:subClassOf>
        <owl:Restriction>
            ...
            <owl:onDataRange rdf:resource = "http://www.w3.org...#string"/>
            <owl:maxQualifiedCardinality rdf:datatype="http://www.w3.org...#integer" >2</owl:maxQualifiedCardinality>
        </owl:Restriction>
    </rdfs:subClassOf>
</rdf:Description>
----
    ...
    <owl:Class>
      <owl:intersectionOf rdf:parseType="Collection">
        <owl:Restriction>
          ...
          <owl:onDataRange rdf:resource = "http://www.w3.org...#string"/>
          <owl:minQualifiedCardinality rdf:datatype="...#integer"
          >1</owl:minQualifiedCardinality>
        </owl:Restriction>
        <owl:Restriction>
          <owl:onProperty rdf:resource = "http://base.onto.uri/property4"/>
          <owl:onDataRange rdf:resource = "http://www.w3.org...#string"/>
          <owl:maxQualifiedCardinality rdf:datatype="...#integer"
...
|
.Min and max cardinality constraints for object property in Turtle syntax
[source,Turtle]
----
:ClassName
  rdfs:subClassOf [
...
----
|
.Min and max cardinality constraints for object property in RDF/XML syntax
[source,XML]
----
<rdf:Description rdf:about = "http://base.onto.uri/ClassName">
  <rdfs:subClassOf>
